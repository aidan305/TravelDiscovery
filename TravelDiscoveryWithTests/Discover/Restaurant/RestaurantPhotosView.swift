...
//  TravelDiscovery
//
//  Created by aidan egan on 21/01/2021.
//
                    ...
                    .fullScreenCover(isPresented: $shouldShowFullScreenModal, content: {
                        ZStack(alignment: .topLeading){
                            ...
                            VStack(alignment: .center) {
                                Spacer()
                                DestinationHeaderContainer(imageUrlStrings: photoUrlStrings, selectionIndex: selectedPhotoIndex)
                                    .scaledToFit()
                                Spacer()
                            }
                ...
                if mode == "grid" {
                    ...
                    ForEach(photoUrlStrings, id: \.self) { urlString in
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            .font(.system(size: 24))
                            Text("Description for you post and it goes here, make sure to use lots of text Description for you post and it goes here, make sure to use lots of text")
                                .font(.system(size: 14))
                                .padding(.horizontal, 8)
                            
                            Text("Posted on 10/01/21")
                                .font(.system(size: 14))
                                .padding(.horizontal, 8)
